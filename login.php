...
<head>
    ...
    <title>Login - Electronic Point of Sales (E-POS) Tempoyak Mak Syalu</title>
...
<style>
.login-background {
    background-image: url('assets/img/bannerlogin.jpg'); 
                    ...
                    <div class="card-body p-0">
						...
						<div class="p-5">
							<div class="text-center">
								<h4 class="h4 text-gray-900 mb-4"><b>Login Electronic Point of Sales Tempoyak Mak Syalu</b></h4>
							</div>
