...
<!-- Sidebar -->
 <style>
 .sidebar-yellow {
    background-color:rgba(221, 176, 69, 0.2) !important; 
    
}
</style>
<ul class="navbar-nav sidebar sidebar-light accordion sidebar-yellow" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        ...
        <div class="sidebar-brand-text mx-3">E-POS System<sup></sup></div>
    </a>
